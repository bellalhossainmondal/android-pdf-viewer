 ...
 */
package com.bellalhossainmondal.pdfviewer;
...
import com.bellalhossainmondal.pdfviewer.bookmark.Bookmarks;
import com.bellalhossainmondal.pdfviewer.exception.PageRenderingException;
import com.bellalhossainmondal.pdfviewer.link.DefaultLinkHandler;
import com.bellalhossainmondal.pdfviewer.link.LinkHandler;
import com.bellalhossainmondal.pdfviewer.listener.Callbacks;
import com.bellalhossainmondal.pdfviewer.listener.OnDrawListener;
import com.bellalhossainmondal.pdfviewer.listener.OnErrorListener;
import com.bellalhossainmondal.pdfviewer.listener.OnLoadCompleteListener;
import com.bellalhossainmondal.pdfviewer.listener.OnLongPressListener;
import com.bellalhossainmondal.pdfviewer.listener.OnPageChangeListener;
import com.bellalhossainmondal.pdfviewer.listener.OnPageErrorListener;
import com.bellalhossainmondal.pdfviewer.listener.OnPageScrollListener;
import com.bellalhossainmondal.pdfviewer.listener.OnRenderListener;
import com.bellalhossainmondal.pdfviewer.listener.OnTapListener;
import com.bellalhossainmondal.pdfviewer.meta.DocumentMetaData;
import com.bellalhossainmondal.pdfviewer.model.PagePart;
import com.bellalhossainmondal.pdfviewer.scroll.ScrollHandle;
import com.bellalhossainmondal.pdfviewer.source.AssetSource;
import com.bellalhossainmondal.pdfviewer.source.ByteArraySource;
import com.bellalhossainmondal.pdfviewer.source.DocumentSource;
import com.bellalhossainmondal.pdfviewer.source.FileSource;
import com.bellalhossainmondal.pdfviewer.source.InputStreamSource;
import com.bellalhossainmondal.pdfviewer.source.UriSource;
import com.bellalhossainmondal.pdfviewer.util.Constants;
import com.bellalhossainmondal.pdfviewer.util.FitPolicy;
import com.bellalhossainmondal.pdfviewer.util.MathUtils;
import com.bellalhossainmondal.pdfviewer.util.SnapEdge;
import com.bellalhossainmondal.pdfviewer.util.Util;
import com.bellalhossainmondal.pdfium.PdfDocument;
import com.bellalhossainmondal.pdfium.PdfiumCore;
import com.bellalhossainmondal.pdfium.util.Size;
import com.bellalhossainmondal.pdfium.util.SizeF;
...
public class PDFView extends RelativeLayout {
    ...
    // bookmark dialog
    private final Bookmarks bookmarkDialog;
    private DocumentMetaData metaDialog;
    ...
    public PDFView(Context context, AttributeSet set) {
        ...
        bookmarkDialog = new Bookmarks(context, this);

        // Initialize the bookmark dialog
        metaDialog = new DocumentMetaData(context, this);
    ...
    public class Configurator {
        ...
        private Configurator(DocumentSource documentSource) {
            ...
            // Determine system night mode
            Context context = PDFView.this.getContext();
            int uiMode = context.getResources().getConfiguration().uiMode;
            this.nightMode = (uiMode & Configuration.UI_MODE_NIGHT_MASK) == Configuration.UI_MODE_NIGHT_YES;
        }
    ...
    /**
     * Show the meta dialog
     */
    public void showMetaDialog() {
        if (metaDialog != null) {
            metaDialog.show();
        }
    }
    ...
    /**
     * Dismiss the meta dialog
     */
    public void dismissMetaDialog() {
        if (metaDialog != null && metaDialog.isShowing()) {
            metaDialog.dismiss();
        }
    }
}
