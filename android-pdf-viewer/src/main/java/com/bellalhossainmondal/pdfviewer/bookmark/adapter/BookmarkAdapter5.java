 ...
 * (handled by BookmarkAdapter6) is initialized.
...
public class BookmarkAdapter5 extends RecyclerView.Adapter<BookmarkAdapter5.BookmarkViewHolder> {
    private final List<PdfDocument.Bookmark> bookmarks;
    private final PDFView pdfView;

    public BookmarkAdapter5(List<PdfDocument.Bookmark> bookmarks, PDFView pdfView) {
    ...
    public void onBindViewHolder(@NonNull BookmarkViewHolder holder, int position) {
        ...
        if (bookmark.hasChildren()) {
            ...
            if (holder.recyclerView.getAdapter() == null) {
                BookmarkAdapter6 bookmarkAdapter = new BookmarkAdapter6(bookmark.getChildren(), pdfView);
