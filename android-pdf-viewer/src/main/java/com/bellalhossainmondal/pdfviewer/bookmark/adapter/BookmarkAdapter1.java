 ...
 * (handled by BookmarkAdapter2) is initialized.
...
public class BookmarkAdapter1 extends RecyclerView.Adapter<BookmarkAdapter1.BookmarkViewHolder> {
    private final List<PdfDocument.Bookmark> bookmarks;
    private final PDFView pdfView;

    public BookmarkAdapter1(List<PdfDocument.Bookmark> bookmarks, PDFView pdfView) {
    ...
    public void onBindViewHolder(@NonNull BookmarkViewHolder holder, int position) {
        ...
        if (bookmark.hasChildren()) {
            ...
            if (holder.recyclerView.getAdapter() == null) {
                BookmarkAdapter2 bookmarkAdapter = new BookmarkAdapter2(bookmark.getChildren(), pdfView);
