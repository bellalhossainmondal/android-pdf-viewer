 ...
 * (handled by BookmarkAdapter3) is initialized.
...
public class BookmarkAdapter2 extends RecyclerView.Adapter<BookmarkAdapter2.BookmarkViewHolder> {
    private final List<PdfDocument.Bookmark> bookmarks;
    private final PDFView pdfView;

    public BookmarkAdapter2(List<PdfDocument.Bookmark> bookmarks, PDFView pdfView) {
    ...
    public void onBindViewHolder(@NonNull BookmarkViewHolder holder, int position) {
        ...
        if (bookmark.hasChildren()) {
            ...
            if (holder.recyclerView.getAdapter() == null) {
                BookmarkAdapter3 bookmarkAdapter = new BookmarkAdapter3(bookmark.getChildren(), pdfView);
