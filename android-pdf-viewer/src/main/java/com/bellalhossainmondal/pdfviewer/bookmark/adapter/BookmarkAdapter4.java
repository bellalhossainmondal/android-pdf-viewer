 ...
 * (handled by BookmarkAdapter5) is initialized.
...
public class BookmarkAdapter4 extends RecyclerView.Adapter<BookmarkAdapter4.BookmarkViewHolder> {
    private final List<PdfDocument.Bookmark> bookmarks;
    private final PDFView pdfView;

    public BookmarkAdapter4(List<PdfDocument.Bookmark> bookmarks, PDFView pdfView) {
    ...
    public void onBindViewHolder(@NonNull BookmarkViewHolder holder, int position) {
        ...
        if (bookmark.hasChildren()) {
            ...
            if (holder.recyclerView.getAdapter() == null) {
                BookmarkAdapter5 bookmarkAdapter = new BookmarkAdapter5(bookmark.getChildren(), pdfView);
